...
> 标注 `[待真实数据]` 的行需要先接入真实项目 / LLM key / ReproBreak DB 才有最终数字。
...
| RQ4 真实 wall-clock + NetSaving `[待真实数据]` | `out/real/*_rq4.json` | full vs selected 的 median/IQR、NetSaving、盈亏平衡、machine-minutes |
